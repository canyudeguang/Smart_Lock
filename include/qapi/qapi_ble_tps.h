 ...
 */
QAPI_BLE_DECLARATION int QAPI_BLE_BTPSAPI qapi_BLE_TPS_Initialize_Service(int32_t BluetoothStackID, uint32_t *ServiceID);
 ...
 *                 QAPI_BLE_BTGATT_ERROR_NOT_INITIALIZED
 */
QAPI_BLE_DECLARATION int QAPI_BLE_BTPSAPI qapi_BLE_TPS_Initialize_Service_Handle_Range(int32_t BluetoothStackID, uint32_t *ServiceID, qapi_BLE_GATT_Attribute_Handle_Group_t *ServiceHandleRange);
 ...
 */
QAPI_BLE_DECLARATION int QAPI_BLE_BTPSAPI qapi_BLE_TPS_Cleanup_Service(int32_t BluetoothStackID, uint32_t InstanceID);
 ...
 */
QAPI_BLE_DECLARATION int32_t QAPI_BLE_BTPSAPI qapi_BLE_TPS_Query_Number_Attributes(void);
 ...
 *                 QAPI_BLE_TPS_ERROR_INVALID_INSTANCE_ID
 */
QAPI_BLE_DECLARATION int QAPI_BLE_BTPSAPI qapi_BLE_TPS_Set_Tx_Power_Level(int32_t BluetoothStackID, uint32_t InstanceID, int8_t Tx_Power_Level);
 ...
 *                 QAPI_BLE_TPS_ERROR_INVALID_INSTANCE_ID
 */
QAPI_BLE_DECLARATION int QAPI_BLE_BTPSAPI qapi_BLE_TPS_Query_Tx_Power_Level(int32_t BluetoothStackID, uint32_t InstanceID, int8_t *Tx_Power_Level);
