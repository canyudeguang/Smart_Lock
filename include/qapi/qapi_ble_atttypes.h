...
*/
/*****< atttypes.h >***********************************************************/
/*      Copyright 2009 - 2016 Qualcomm Technologies, Inc.                     */
/*      All Rights Reserved.                                                  */
/*                                                                            */
...
#define QAPI_BLE_QAPI_BLE_ASSIGN_ATT_AUTHENTICATION_SIGNATURE_SIGN_COUNTER(_x, _y)  ASSIGN_HOST_DWORD_TO_LITTLE_ENDIAN_UNALIGNED_DWORD((_x), (_y))
...
#define QAPI_BLE_QAPI_BLE_ASSIGN_ATT_AUTHENTICATION_SIGNATURE_CMAC(_x, _y)          ASSIGN_UNALIGNED_GENERIC_TYPE(((SM_MAC_t *)&(((uint8_t *)(_x))[sizeof(uint32_t)])), (_y))
