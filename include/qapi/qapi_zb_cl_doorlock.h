...
/** @file qapi_zb_cl_doorlock.h
   ...
   APIs are provided to create a Door lock server and client cluster.
...
#define QAPI_ZB_CL_DOORLOCK_ATTR_ID_ACTUATOR_ENABLED                            (0x0002) /**< Door lock cluster attribute ID for the actuator enabled (read only, bool). */
#define QAPI_ZB_CL_DOORLOCK_ATTR_ID_DOOR_STATE                                  (0x0003) /**< Door lock cluster attribute ID for the door state (read only, reportable,
                                                                                              enum8). */
#define QAPI_ZB_CL_DOORLOCK_ATTR_ID_DOOR_OPEN_EVENTS                            (0x0004) /**< Door lock cluster attribute ID for the door open events (uint32). */
#define QAPI_ZB_CL_DOORLOCK_ATTR_ID_DOOR_CLOSED_EVENTS                          (0x0005) /**< Door lock cluster attribute ID for the door closed events (uint32). */
...
#define QAPI_ZB_CL_DOORLOCK_ATTR_ID_RFID_USERS_SUPPORTED                        (0x0013) /**< Door lock cluster attribute ID for the number of RFID users supported (read
                                                                                              only, uint16). */
#define QAPI_ZB_CL_DOORLOCK_ATTR_ID_WEEKDAY_SCHEDULES_PER_USER                  (0x0014) /**< Door lock cluster attribute ID for the number of week day schedules
...
#define QAPI_ZB_CL_DOORLOCK_ATTR_ID_MIN_PIN_CODE_LENGTH                         (0x0018) /**< Door lock cluster attribute ID for the minimum length of a PIN code (read
                                                                                              only, uint8). */
#define QAPI_ZB_CL_DOORLOCK_ATTR_ID_MAX_RFID_CODE_LENGTH                        (0x0019) /**< Door lock cluster attribute ID for the maximum length of a RFID code (read
                                                                                              only, uint8). */
#define QAPI_ZB_CL_DOORLOCK_ATTR_ID_MIN_RFID_CODE_LENGTH                        (0x001A) /**< Door lock cluster attribute ID for the minimum length of a RFID code (read
                                                                                              only, uint8). */
...
#define QAPI_ZB_CL_DOORLOCK_ATTR_ID_ZIGBEE_SECURITY_LEVEL                       (0x0034) /**< Door lock cluster attribute ID for required ZigBee security level
                                                                                              (reportable, enum8). */
...
#define QAPI_ZB_CL_DOORLOCK_CLIENT_COMMAND_ID_CLEAR_ALL_PIN_CODE                (0x08) /**< Door lock client command ID for the clear all PIN code command. */
...
#define QAPI_ZB_CL_DOORLOCK_CLIENT_COMMAND_ID_SET_WEEK_DAY_SCHEDULE             (0x0B) /**< Door lock client command ID for the set week day schedule command. */
#define QAPI_ZB_CL_DOORLOCK_CLIENT_COMMAND_ID_GET_WEEK_DAY_SCHEDULE             (0x0C) /**< Door lock client command ID for the get week day schedule command. */
#define QAPI_ZB_CL_DOORLOCK_CLIENT_COMMAND_ID_CLEAR_WEEK_DAY_SCHEDULE           (0x0D) /**< Door lock client command ID for the clear week day schedule. */
...
#define QAPI_ZB_CL_DOORLOCK_CLIENT_COMMAND_ID_CLEAR_ALL_RFID_CODE               (0x19) /**< Door lock client command ID for the clear all RFID code command. */
...
/**
   Structure which represents the PIN code used by the door lock cluster.
*/
