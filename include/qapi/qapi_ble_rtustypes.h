...
*/
/*****< qapi_ble_rtustypes.h >*************************************************/
/*      Copyright 2016 Qualcomm Technologies, Inc.                            */
/*      All Rights Reserved.                                                  */
/*                                                                            */
/*  qapi_ble_rtustypes - QAPI for Bluetopia Bluetooth Stack Reference         */
/*                       Time Update Service Types.                           */
/*                                                                            */
/*  Author:  Ryan McCord                                                      */
/*                                                                            */
...
#define QAPI_BLE_RTUS_RESULT_UPDATE_NOT_ATTEMPTED_AFTER_RESET     0x05
   ...
   /* command.                                                          */
#define QAPI_BLE_RTUS_TIME_UPDATE_CONTROL_POINT_VALID_COMMAND(_x)  ((((Byte_t)(_x)) >= QAPI_BLE_RTUS_TIME_UPDATE_CONTROL_POINT_GET_REFERENCE_UPDATE) &&   \
                                                                    (((Byte_t)(_x)) <= QAPI_BLE_RTUS_TIME_UPDATE_CONTROL_POINT_CANCEL_REFERENCE_UPDATE))
...
#define QAPI_BLE_RTUS_TIME_UPDATE_STATE_VALID(_x,_y)     (((((Byte_t)(_x)) >= QAPI_BLE_RTUS_CURRENT_STATE_IDLE) && (((Byte_t)(_x)) <= QAPI_BLE_RTUS_CURRENT_STATE_UPDATE_PENDING)) && \
                                                          ((((Byte_t)(_y)) >= QAPI_BLE_RTUS_RESULT_SUCCESSFUL) && (((Byte_t)(_y)) <= QAPI_BLE_RTUS_RESULT_UPDATE_NOT_ATTEMPTED_AFTER_RESET)))

   /* The following defines the length of the Reference Time Update     */
   /* Control Point characteristic value.                               */
#define QAPI_BLE_RTUS_TIME_UPDATE_CONTROL_POINT_VALUE_LENGTH      (QAPI_BLE_BYTE_SIZE)
