...
/*      All Rights Reserved.                                                  */
/*                                                                            */
/*  qapi_ble_gapstypes - QAPI for Bluetopia Bluetooth Stack Generic Access    */
...
/*   --------  -----------    ------------------------------------------------*/
/*   09/04/15  R. McCord      Initial creation.                               */
/******************************************************************************/
...
#define QAPI_BLE_GAP_DEVICE_NAME_CHARACTERISTIC_BLUETOOTH_UUID_CONSTANT             { 0x00, 0x2A }
   ...
   /* * NOTE * The UUID will be assigned into the qapi_BLE_UUID_16_t    */
   /*          variable in Little-Endian format.                        */
#define QAPI_BLE_GAP_ASSIGN_DEVICE_APPEARENCE_UUID16(_x)                            QAPI_BLE_ASSIGN_BLUETOOTH_UUID_16((_x), 0x2A, 0x01)
...
#define QAPI_BLE_GAP_DEVICE_NAME_VALID_LENGTH(_x)                 ((((uint16_t)(_x)) >= 0) && (((uint16_t)(_x)) <= QAPI_BLE_GAP_MAXIMUM_DEVICE_NAME_LENGTH))
   ...
   /* Value Length.                                                     */
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_LENGTH               (sizeof(uint16_t))

   /* The following define the value GAP Device Appearence Values.      */
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_UNKNOWN                                                        0
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_GENERIC_PHONE                                                  64
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_GENERIC_COMPUTER                                               128
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_GENERIC_WATCH                                                  192
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_SPORTS_WATCH                                                   193
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_GENERIC_CLOCK                                                  256
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_GENERIC_DISPLAY                                                320
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_GENERIC_GENERIC_REMOTE_CONTROL                                 384
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_GENERIC_EYE_GLASSES                                            448
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_GENERIC_TAG                                                    512
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_GENERIC_KEYRING                                                576
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_GENERIC_MEDIA_PLAYER                                           640
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_GENERIC_BARCODE_SCANNER                                        704
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_GENERIC_THERMOMETER                                            768
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_THERMOMETER_EAR                                                769
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_GENERIC_HEART_RATE_SENSOR                                      832
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_BELT_HEART_RATE_SENSOR                                         833
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_GENERIC_BLOOD_PRESSURE                                         896
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_BLOOD_PRESSURE_ARM                                             897
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_BLOOD_PRESSURE_WRIST                                           898
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_HUMAN_INTERFACE_DEVICE                                         960
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_HID_KEYBOARD                                                   961
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_HID_MOUSE                                                      962
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_HID_JOYSTICK                                                   963
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_HID_GAMEPAD                                                    964
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_HID_DIGITIZER_TABLET                                           965
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_HID_CARD_READER                                                966
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_HID_DIGITAL_PEN                                                967
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_HID_BARCODE_SCANNER                                            968
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_GENERIC_GLUCOSE_METER                                          1024
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_GENERIC_RUNNING_WALKING_SENSOR                                 1088
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_RUNNING_WALKING_SENSOR_IN_SHOE                                 1089
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_RUNNING_WALKING_SENSOR_ON_SHOE                                 1090
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_RUNNING_WALKING_SENSOR_ON_HIP                                  1091
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_GENERIC_CYCLING                                                1152
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_CYCLING_CYCLING_COMPUTER                                       1153
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_CYCLING_SPEED_SENSOR                                           1154
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_CYCLING_CADENCE_SENSOR                                         1155
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_CYCLING_POWER_SENSOR                                           1156
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_CYCLING_SPEED_AND_CADENCE_SENSOR                               1157
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_GENERIC_PULSE_OXIMETER                                         3136
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_PULSE_OXIMETER_FINGERTIP                                       3137
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_PULSE_OXIMETER_WRIST_WORN                                      3138
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_GENERIC_WEIGHT_SCALE                                           3200
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_GENERIC_OUTDOOR_SPORTS_ACTIVITY                                5184
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_OUTDOOR_SPORTS_ACTIVITY_LOCATION_DISPLAY_DEVICE                5185
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_OUTDOOR_SPORTS_ACTIVITY_LOCATION_AND_NAVIGATION_DISPLAY_DEVICE 5186
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_OUTDOOR_SPORTS_ACTIVITY_LOCATION_POD                           5187
#define QAPI_BLE_GAP_DEVICE_APPEARENCE_VALUE_OUTDOOR_SPORTS_ACTIVITY_LOCATION_AND_NAVIGATION_POD            5188
