 ...
 */
QAPI_BLE_DECLARATION unsigned long QAPI_BLE_BTPSAPI qapi_BLE_OTS_Query_Number_Attributes(uint32_t BluetoothStackID, uint32_t InstanceID);
 ...
 *
 * @param[in,out]  Buffer     User-specified buffer.
 *
 ...
 *
 * @param[in,out]  ObjectData    Pointer to the OTS objects that will
