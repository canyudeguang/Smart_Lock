...
/*      All Rights Reserved.                                                  */
/*                                                                            */
/*  qapi_ble_bcstypes - QAPI for Bluetopia Bluetooth Stack Body               */
...
/*   --------  -----------    ------------------------------------------------*/
/*   05/24/16  R. McCord      Initial creation.                               */
/******************************************************************************/
...
#define QAPI_BLE_BCS_BODY_COMPOSITION_MEASUREMENT_MINIMUM_LENGTH(_x)    (QAPI_BLE_BCS_BODY_COMPOSITION_MEASUREMENT_SIZE(0)                                                        + \
                                                               ...
                                                               (((_x) & QAPI_BLE_BCS_BC_MEASUREMENT_FLAG_USER_ID_PRESENT)          ? NON_ALIGNED_BYTE_SIZE : 0)                   + \
                                                               (((_x) & QAPI_BLE_BCS_BC_MEASUREMENT_FLAG_BASAL_METABOLISM_PRESENT) ? NON_ALIGNED_WORD_SIZE : 0)                   + \
                                                               (((_x) & QAPI_BLE_BCS_BC_MEASUREMENT_FLAG_MUSCLE_PERCENTAGE_PRESENT)? NON_ALIGNED_WORD_SIZE : 0)                   + \
                                                               (((_x) & QAPI_BLE_BCS_BC_MEASUREMENT_FLAG_MUSCLE_MASS_PRESENT)      ? NON_ALIGNED_WORD_SIZE : 0)                   + \
                                                               (((_x) & QAPI_BLE_BCS_BC_MEASUREMENT_FLAG_FAT_FREE_MASS_PRESENT)    ? NON_ALIGNED_WORD_SIZE : 0)                   + \
                                                               (((_x) & QAPI_BLE_BCS_BC_MEASUREMENT_FLAG_SOFT_LEAN_MASS_PRESENT)   ? NON_ALIGNED_WORD_SIZE : 0)                   + \
                                                               (((_x) & QAPI_BLE_BCS_BC_MEASUREMENT_FLAG_BODY_WATER_MASS_PRESENT)  ? NON_ALIGNED_WORD_SIZE : 0)                   + \
                                                               (((_x) & QAPI_BLE_BCS_BC_MEASUREMENT_FLAG_IMPEDANCE_PRESENT)        ? NON_ALIGNED_WORD_SIZE : 0)                   + \
                                                               (((_x) & QAPI_BLE_BCS_BC_MEASUREMENT_FLAG_WEIGHT_PRESENT)           ? NON_ALIGNED_WORD_SIZE : 0)                   + \
                                                               (((_x) & QAPI_BLE_BCS_BC_MEASUREMENT_FLAG_HEIGHT_PRESENT)           ? NON_ALIGNED_WORD_SIZE : 0))
