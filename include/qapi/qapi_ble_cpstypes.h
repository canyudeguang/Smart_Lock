...
/*      All Rights Reserved.                                                  */
/*                                                                            */
/*  qapi_ble_cpstypes - QAPI for Bluetopia Bluetooth Stack Cycling            */
/*                      Power Service Types.                                  */
/*                                                                            */
/*  Author:  Ryan McCord                                                      */
/*                                                                            */
...
/*   --------  -----------    ------------------------------------------------*/
/*   05/27/16  R. McCord      Initial creation.                               */
/******************************************************************************/
...
#define QAPI_BLE_CPS_VECTOR_SIZE(_x)                     (QAPI_BLE_BTPS_STRUCTURE_OFFSET(qapi_BLE_CPSVector_t, Variable_Data) + ((_x) * NON_ALIGNED_BYTE_SIZE))
...
#define QAPI_BLE_CPS_CONTROL_POINT_SIZE(_x)              (QAPI_BLE_BTPS_STRUCTURE_OFFSET(qapi_BLE_CPSControl_Point_t, Variable_Data) + ((_x) * NON_ALIGNED_BYTE_SIZE))
