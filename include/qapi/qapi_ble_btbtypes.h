...
/*      All Rights Reserved.                                                  */
/*                                                                            */
/*  QAPI_BLE_BTBTYPES - Common Bluetooth Base Defined Types.                  */
/*                                                                            */
/*  Author:  Tim Cook                                                         */
/*                                                                            */
...
#define QAPI_BLE_QAPI_BLE_ASSIGN_SDP_UUID_16_TO_SDP_UUID_128(_dest, _src)                             \
{                                                                                   \
   ...
   /* qapi_BLE_UUID_16_t) to extend to a 32 Bit UUID, and then assign to*/
   /* the specified 128 Bit UUID.                                       */
#define QAPI_BLE_QAPI_BLE_ASSIGN_BLUETOOTH_UUID_16_TO_BLUETOOTH_UUID_128(_dest, _src)                   \
{                                                                                     \
...
#define QAPI_BLE_QAPI_BLE_ASSIGN_SDP_UUID_32_TO_SDP_UUID_128(_dest, _src)                             \
{                                                                                   \
   ...
   /* the second parameter is the 32 Bit UUID variable (of type         */
   /* qapi_BLE_UUID_32_t) to assign to the specified 128 Bit UUID.      */
#define QAPI_BLE_QAPI_BLE_ASSIGN_BLUETOOTH_UUID_32_TO_BLUETOOTH_UUID_128(_dest, _src)                 \
{                                                                                   \
   (_dest).UUID_Byte0 = (_src).UUID_Byte0;  (_dest).UUID_Byte1 = (_src).UUID_Byte1; \
   (_dest).UUID_Byte2 = (_src).UUID_Byte2;  (_dest).UUID_Byte3 = (_src).UUID_Byte3; \
}
