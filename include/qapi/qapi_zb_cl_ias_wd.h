...
/** @file qapi_zb_cl_ias_wd.h
   ...
   APIs are provided to create an IAS WD server and client cluster.  Cluster
...
#define QAPI_ZB_CL_IASWD_ATTR_ID_MAX_DURATION                                   (0x0000) /**< IAS WD attribute ID for the max duration (uint16). */
...
/* The following defintions represent the command IDs for the IAS WD client
   ...
   responses. */
#define QAPI_ZB_CL_IASWD_CLIENT_COMMAND_ID_START_WARNING                        (0x00) /**< IAS WD client cluster CMD ID for the Start Warning. */
#define QAPI_ZB_CL_IASWD_CLIENT_COMMAND_ID_SQUAWK                               (0x01) /**< IAS WD client cluster CMD ID for the Squawk. */
...
typedef enum
{
   ...
   QAPI_ZB_CL_IASWD_WARNING_MODE_BURGLAR_E         = 0x01, /**< Burgalar. */
...
/**
   Structure representing the data for events received by a IAS WD client
   cluster.
*/
...
/**
   Structure representing the data for events received by a IAS WD server
   cluster.
*/
...
/**
   @brief This function can be used to populate an attribute list with the
          attributes required for an IAS WD cluster.
