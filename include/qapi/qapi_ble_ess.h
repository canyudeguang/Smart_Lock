...
/**
 * @brief
 * The following function is responsible for formatting the ES Trigger
 ...
 * during service discovery.
 *
 * If the BufferLength parameter is set to zero, then the
 ...
 *
 * @return      Positive, non-zero, which represents the minimum length of the
