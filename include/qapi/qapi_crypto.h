 ...
 * @param[in]  max_key_size Maximum key size.
 ...
 * @param[in]  max_key_size  Maximum key size used in the operation.
 ...
 *                       For AES-CCM, the length must be a multiple of 8 and >= 32 and <= 128.
 ...
 * @param[in] attr_count  Number of attributes.
 * @param[in] derived_key_hdl  Object where the derived key value is to be stored.
 *
 * @return int.
 */
