...
/*      All Rights Reserved.                                                  */
/*                                                                            */
/*  QAPI_BLE_HCITYPES - Bluetooth HCI Type Definitions/Constants.             */
/*                                                                            */
/*  Author:  Tim Cook                                                         */
/*                                                                            */
...
/*   01/11/17  R. McCord      Changes for BT 5.0                              */
/******************************************************************************/
...
{                                                                                                                               \
   ...
   (_w)->DriverInformation.COMMDriverInformation.BaudRate              = (uint32_t)(_y);                                        \
...
{                                                                                                                             \
   ...
   /* as the first argument to this MACRO will be able to be passed to  */
   /* the HCI_OpenDriver() function without any further processing.     */
#define QAPI_BLE_QAPI_BLE_HCI_DRIVER_SET_EXTENDED_USB_INFORMATION_DELAY(_w, _x, _y)                                           \
{                                                                                                                             \
   (_w)->DriverType                                                   = QAPI_BLE_USB_DRIVER_E;                                \
   (_w)->DriverInformation.USBDriverInformation.DriverInformationSize = sizeof((_w)->DriverInformation.USBDriverInformation); \
   (_w)->DriverInformation.USBDriverInformation.DriverType            = (_x);                                                 \
...
typedef void (QAPI_BLE_BTPSAPI *qapi_BLE_HCI_Driver_Packet_Write_Callback_t)(uint32_t CallbackParameter);
...
#define QAPI_BLE_QAPI_BLE_HCI_COMMAND_OPCODE_AMP_TEST_END                                 (QAPI_BLE_HCI_MAKE_COMMAND_OPCODE(QAPI_BLE_HCI_COMMAND_CODE_TESTING_COMMANDS_OGF, QAPI_BLE_HCI_COMMAND_CODE_AMP_TEST_END_OCF))
...
#define QAPI_BLE_QAPI_BLE_HCI_ENABLE_ALL_HCI_EVENTS_IN_EVENT_MASK_PAGE_2(_x)                                            \
{                                                                                                     \
   QAPI_BLE_ASSIGN_EVENT_MASK((_x), 0, 0, 0, 0, 0, 0, 0, 0);                                                   \
   ...
   /* * NOTE * This MACRO is only valid for Events located in the Page 2*/
   /*          Event Mask NOT the Page 1 Event Mask !!!!!!!!!!!!!!!!!   */
#define QAPI_BLE_QAPI_BLE_HCI_DISABLE_ALL_HCI_EVENTS_IN_EVENT_MASK_PAGE_2(_x)                                              \
{                                                                                                        \
   QAPI_BLE_ASSIGN_EVENT_MASK((_x), 0, 0, 0, 0, 0, 0, 0, 0);                                                      \
   QAPI_BLE_SET_EVENT_MASK_BIT((_x), QAPI_BLE_HCI_EVENT_MASK_PHYSICAL_LINK_COMPLETE_BIT_NUMBER);                         \
   QAPI_BLE_SET_EVENT_MASK_BIT((_x), QAPI_BLE_HCI_EVENT_MASK_CHANNEL_SELECTED_BIT_NUMBER);                               \
