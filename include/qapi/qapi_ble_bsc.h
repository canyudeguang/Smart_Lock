...
/**< Special value used for the TxPower field in qapi_BLE_BSC_SetTxPower() to revert back to the default value. */
 ...
 *                                            asynchronously.
 *
 * @param[in]  CallbackParameter              Uer-defined parameter
 ...
 *                              will revert back to the system
 *                              default.
 *
 * @return      Zero value if successful.
 *
 ...
 *                              is being enabled.
 *                              Not used if override is being disabled.
 *
