 ...
 * Channel data.
 *
 * The Max SDU Size denotes the maximum Service Data Unit that the local
 * device is capable of receiving from the remote device.
 *
 * The Max PDU Size (MPS) denotes the maximum L2CAP Packet (LE-Frame)
 * that the local device is capable of receiving from the remote device.
 * If the Max SDU Size is larger than the Max PDU Size, the SDU will
