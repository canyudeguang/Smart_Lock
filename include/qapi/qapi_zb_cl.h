...
typedef enum
{
   ...
   QAPI_ZB_CL_CUSTOM_CLUSTER_EVENT_TYPE_ATTR_SET_DEFAULT_E   /**< Event to set the attribute to its default value. */
...
{
   /** Length of the buffer provided to store scene data. */
   uint8_t           *DataLength;
...
typedef struct qapi_ZB_CL_Custom_Cluster_Event_Data_s
{
   ...
   union
   {
      ...
      /** Information for attribute set default events. */
      qapi_ZB_CL_Custom_Cluster_Attr_Set_Default_t Attr_Set_Default_Data;
...
/**
   @brief Sets the value of the discove route flag used when sending packets for
...
/**
   @brief Gets the value of the discove route flag for the specified cluster.
...
/**
   ...
   @param[in] Cluster       Handle of the cluster.
   @param[in] DiscoverRoute Radius used when sending packets for this cluster.
...
/**
   ...
   @param[in]  Cluster       Handle of the cluster.
   @param[out] DiscoverRoute Radius used when sending packets for this cluster.
...
/**
   @brief Sends a default response for a received ZCL custom command.
   ...
   @return
     ...
     - A negative value if there was an error.
*/
qapi_Status_t qapi_ZB_CL_Default_Response(qapi_ZB_Cluster_t Cluster, const qapi_ZB_APSDE_Data_Indication_t *APSDEData, const qapi_ZB_CL_Header_t *ZCLHeader, uint8_t Status);
