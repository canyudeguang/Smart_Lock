...
/**
   @brief Creates an endpoint used in a ZigBee certification test.

   @param[in] ZB_Handle        Handle of the ZigBee instance.
   @param[in,out] TestEndpoint Pointer to where the handle of the newly-created
                               test endpoint will be stored on a successful
                               return.
   @param[in] ProfileID        Profile ID associated with the test endpoint.
...
/**
   @brief Destroys the test endpoint created with
          qapi_ZB_APS_Create_Test_Endpoint().

   @param[in] ZB_Handle    Handle of the ZigBee instance.
   @param[in] TestEndpoint Handle of the test endpoint to be destroyed.
...
/**
   @brief Sends an APS data request over the test endpoint.

   @param[in] ZB_Handle    Handle of the ZigBee instance.
   @param[in] TestEndpoint Handle of the test endpoint.
   @param[in] RequestData  Information for the request.
   @param[in] RspClusterID ID of the cluster that will handle the response to
                           the request.
