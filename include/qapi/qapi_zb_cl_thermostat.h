...
/** @file qapi_zb_cl_thermostat.h
   ...
   APIs are provided to create a Thermostat server and client cluster.
...
/* The following definitions represent the attribute IDs for the thermostat
   cluster. */
#define QAPI_ZB_CL_THERMOSTAT_ATTR_ID_LOCAL_TEMPERATURE                         (0x0000) /**< Thermostat cluster attribute ID for the local temperature (read only,
                                                                                              reportable, int16). */
#define QAPI_ZB_CL_THERMOSTAT_ATTR_ID_OUTDOOR_TEMPERATURE                       (0x0001) /**< Thermostat cluster attribute ID for the outdoor temperature (read only,
                                                                                              int16). */
...
#define QAPI_ZB_CL_THERMOSTAT_ATTR_ID_AC_LOUVER_POSITION                        (0x0045) /**< Thermostat cluster attribute ID for the AC louver position (enum8). */
...
/**
   Enumeration of control sequence of operation values for the thermostat
   cluster.
*/
typedef enum
{
...
typedef struct qapi_ZB_CL_Thermostat_Server_Setpoint_Change_s
{
   ...
   /** The amount of change associated with the setpoint*/
   int8_t                                Amount;
...
/**
   ...
   This function is used to create an thermostat client cluster for a
   specific endpoint. The cluster can be destroyed using
   qapi_ZB_CL_Destroy_Cluster() in the qapi_zb_cl.h API.

   The callback registered with this function will provide responses to color
