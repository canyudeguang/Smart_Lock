...
/** @file qapi_zb_cl_wincover.h
   ...
   APIs are provided to create a window covering server and client cluster.
...
#define QAPI_ZB_CL_WINCOVER_ATTR_ID_CONFIG_STATUS                               (0x0007) /**< Window covering cluster attribute ID for the config and status (read only, map8). */
...
typedef enum
{
   ...
   QAPI_ZB_CL_WINCOVER_COVER_TYPE_ROLLERSHADE_2_MOTOR_E          = 0x00, /**< 2 motor rollershade. */
   QAPI_ZB_CL_WINCOVER_COVER_TYPE_ROLLERSHADE_EXTERIOR_E         = 0x00, /**< Exterior rollershade. */
   QAPI_ZB_CL_WINCOVER_COVER_TYPE_ROLLERSHADE_EXTERIOR_2_MOTOR_E = 0x00, /**< 2 motor exterior rollershade. */
...
typedef enum
{
   QAPI_ZB_CL_WINCOVER_ACTION_OPEN_E,  /**< Indicates the window covering should move to the up/open state. */
   QAPI_ZB_CL_WINCOVER_ACTION_CLOSE_E, /**< Indicates the window covering should move to the down/closed state. */
   QAPI_ZB_CL_WINCOVER_ACTION_STOP_E   /**< Indicates the window covering should stop moving. */
...
/**
   @brief Populate an attribute list with the attributes required for a window
          covering cluster.
