 ...
 *          vibrators. The Qualcomm SoC incorporates dedicated hardware to generate an
...
$Header: //components/rel/core.ioe/1.0/v2/rom/release/api/iodevices/pwm/qapi_pwm.h#4 $
