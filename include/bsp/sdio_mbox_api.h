...
/*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  @prototype: void mbox_init(MBOX_HW_CONFIG *pConfig)
  @input:   pConfig - configuration (containing callbacks)
  @output:
  @return:
  @notes: This API initializes internal state structures. DMA engines are not
          initialized and no DMA resources are allocated.
...
void* mbox_init(int InstanceId, int mbox_used);
...
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
void mbox_write_scratchbyte(int InstanceId, int mbox, uint8 byte);
...
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
uint8 mbox_read_scratchbyte(int InstanceId, int mbox);
