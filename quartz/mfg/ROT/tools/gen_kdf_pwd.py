...
This script generates a KDF password
...
class KDF_Operator:
    ...
    def check_parameters(self):
        if (self.op_code != 7 ) and (self.op_code != 8) :
    ...
    def set_wrap_key(self, wrap_key):
        if self.dbg_enable == 1:
            ...
            data = self.kdf_packed.pack( ( (self.iteration & 0x03) << 6 | 0x03), self.mid)
