...
@ECHO ****************************************************************************
@ECHO                      Building Quartz OTP Application for %CHIPSET% Chipset
...
REM SET CSrcs=%CSrcs% otp\otp.c
SET CSrcs=%CSrcs% app\app.c
SET CSrcs=%CSrcs% app\otp_params.c
...
SET Includes=%Includes% -I"%RootDir%\quartz\mfg\OTP\src\app"
...
SET Libs=%Libs% "%LibDir%\nichestack.lib"
SET Libs=%Libs% "%SrcDir%\prebuilt\otp.o" 
...
REM generate otp_params.c
DEL /F %SrcDir%\app\otp_params.c >NUL 2>&1
