...
******************************************************************************/
/*
  * This file contains Composition Data of the Provisioner device
 */
/*****************************************************************************/
 ...
 */
const uint16_t provisioner_sig_model_ids[] =  {
...
uint16_t provisioner_model_sub_list[3][QMESH_MAX_SUB_ADDRS_LIST] = {{QMESH_UNASSIGNED_ADDRESS}};
...
QMESH_MODEL_PUBLISH_STATE_T provisioner_publish_state[] =
{
    ...
    /* Publish data for Config Client model */
    {
        QMESH_INVALID_KEY_INDEX,                /* app_key_idx */
        QMESH_UNASSIGNED_ADDRESS,          /* publish_addr */
        NULL,                                                    /* publish_uuid */
...
QMESH_MODEL_DATA_T provisioner_model_data[] =
{
    /* Initialize the Config server model data */
    {
        &provisioner_publish_state[0],                          /* publish_state */
    ...
    /* Initialize the Config client model data */
    {
        &provisioner_publish_state[1],                        /* publish_state */
    ...
    {
        &provisioner_publish_state[2],                      /* publish_state */
...
QMESH_ELEMENT_DATA_T provisioner_element_data =
{
    START_SEQUENCE_NUMBER,                              /* seq_num */
    LOCAL_UNICAST_ADDRESS,                               /* unicast address */
    provisioner_model_data                                  /* model_data */
};

/* Array holding the element list on the device */
const QMESH_ELEMENT_CONFIG_T provisioner_element_list[NUMER_OF_ELEMENT] =
{
    {
        ELEMENT_LOCATION_FRONT,                        /* Location of the element */
        /* Num of sig models */
        sizeof(provisioner_sig_model_ids)  / sizeof(uint16_t),  
        0,                                                                 /* Num of vendor models */
        provisioner_sig_model_ids,                       /* Sig model ids */
        NULL,                                                           /* Vendor model ids */
        &provisioner_element_data                      /* element_data */
    }
};
...
{ 
    ...
    provisioner_element_list        /* Element list */
};
...
{
    return provisioner_element_data.unicast_addr;
}
