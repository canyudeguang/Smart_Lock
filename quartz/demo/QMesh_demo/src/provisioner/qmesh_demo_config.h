...
******************************************************************************/
/*
  * This file contains various configurations parameters for the Provisioner application
 */
/*****************************************************************************/
...
/* Delay in msec after which config app key add message is to be sent out */
#define QMESH_DEMO_APP_KEY_ADD_DELAY                (2000)
