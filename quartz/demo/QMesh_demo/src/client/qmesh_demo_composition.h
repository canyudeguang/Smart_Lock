...
extern const uint16_t client_sig_model_ids[];
/* Subscription list */
extern uint16_t client_model_sub_list[3][QMESH_MAX_SUB_ADDRS_LIST];
extern uint8_t onbootpowerup;
/* Array holding the model data for each of the models supported */
extern QMESH_MODEL_PUBLISH_STATE_T client_publish_state[];
/* Array holding the model data for each of the models supported */
extern QMESH_MODEL_DATA_T client_model_data[];
/* Element data on the Client */
extern QMESH_ELEMENT_DATA_T client_element_data;
/* Server Element List */
extern const QMESH_ELEMENT_CONFIG_T client_element_list[NUMER_OF_ELEMENT];
