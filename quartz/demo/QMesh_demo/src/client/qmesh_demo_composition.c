...
******************************************************************************/
/*
  * This file contains Composition Data of the Client node device
 */
/*****************************************************************************/
 ...
 */
const uint16_t client_sig_model_ids[] =  {
                                         QMESH_CONFIG_SERVER_MODEL_ID,
                                         QMESH_HEALTH_SERVER_MODEL_ID,
                                         QMESH_GENERIC_ONOFF_CLIENT_MODEL_ID
                               };
...
uint16_t client_model_sub_list[3][QMESH_MAX_SUB_ADDRS_LIST] = {{QMESH_UNASSIGNED_ADDRESS}};
...
QMESH_MODEL_PUBLISH_STATE_T client_publish_state[] =
{
    ...
    /* Publish data for GenericOnOff Client model */
    {
        QMESH_INVALID_KEY_INDEX,                /* app_key_idx */
        QMESH_UNASSIGNED_ADDRESS,          /* publish_addr */
        NULL,                                                    /* publish_uuid */
...
QMESH_MODEL_DATA_T client_model_data[] =
{
    /* Initialize the Config server model data */
    {
        &client_publish_state[0],                          /* publish_state */
    ...
    {
        &client_publish_state[1],                      /* publish_state */
    ...
    /* Initialize the Generic OnOff client model data */
    {
        &client_publish_state[2],                        /* publish_state */
...
/* Element data on the Client */
QMESH_ELEMENT_DATA_T client_element_data =
{
    START_SEQUENCE_NUMBER,                              /* seq_num */
    LOCAL_UNICAST_ADDRESS,                               /* unicast address */
    client_model_data                                          /* model_data */
};

/* Array holding the element list on the device */
const QMESH_ELEMENT_CONFIG_T client_element_list[NUMER_OF_ELEMENT] =
{
    {
        ELEMENT_LOCATION_FRONT,                        /* Location of the element */
        /* Num of sig models */
        sizeof(client_sig_model_ids)  / sizeof(uint16_t),  
        0,                                                                 /* Num of vendor models */
        client_sig_model_ids,                       /* Sig model ids */
        NULL,                                                           /* Vendor model ids */
        &client_element_data                      /* element_data */
    }
};
...
{ 
    ...
    client_element_list                  /* Element list */
};
...
{
    return client_element_data.unicast_addr;
}
