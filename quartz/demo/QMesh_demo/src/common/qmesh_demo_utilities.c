...
#ifdef CONFIG_QMESH_SERVER_DEMO
...
/* Displays an array of uint16_t type */
...
/* Displays an array of uint32_t type */
...
/* This function converts ASCII characters to Hexadecimal value */
