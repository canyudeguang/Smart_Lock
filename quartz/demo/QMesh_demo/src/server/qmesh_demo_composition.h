...
extern const uint16_t server_sig_model_ids[];
/* Subscription list */
extern uint16_t server_model_sub_list[3][QMESH_MAX_SUB_ADDRS_LIST];
extern uint8_t onbootpowerup;
/* Array holding the model data for each of the models supported */
extern QMESH_MODEL_PUBLISH_STATE_T server_publish_state[];
/* Array holding the model data for each of the models supported */
extern QMESH_MODEL_DATA_T server_model_data[];
/* Element data on the Server */
extern QMESH_ELEMENT_DATA_T server_element_data;
/* Server Element List */
extern const QMESH_ELEMENT_CONFIG_T server_element_list[NUMER_OF_ELEMENT];
...
/*----------------------------------------------------------------------------*
 * DemoGetConfigServerElemAddr
 */
/*! \brief Returns the Unicast address of the Server device.
 *
 *  \param none
 *
