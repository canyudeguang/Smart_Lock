...
#ifndef __ZCL_IASZONE_DEMO_H__
#define __ZCL_IASZONE_DEMO_H__

/**
   @brief Initializes the ZCL IAS zone demo.

   @param ZigBee_QCLI_Handle is the parent QCLI handle for the IAS Zone demo.

   @return true if the ZigBee IAS zone demo initialized successfully, false
           otherwise.
*/
qbool_t Initialize_ZCL_IASZone_Demo(QCLI_Group_Handle_t ZigBee_QCLI_Handle);

/**
   @brief Creates an IAS zone server cluster.
...
/**
   @brief Creates an IAS zone client cluster.
