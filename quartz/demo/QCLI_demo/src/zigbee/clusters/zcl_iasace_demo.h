...
#ifndef __ZCL_IASACE_DEMO_H__
#define __ZCL_IASACE_DEMO_H__

/**
   @brief Initializes the ZCL IAS ACE demo.

   @param ZigBee_QCLI_Handle is the parent QCLI handle for the IAS Zone demo.

   @return true if the ZigBee IAS ACE demo initialized successfully, false
           otherwise.
*/
qbool_t Initialize_ZCL_IASACE_Demo(QCLI_Group_Handle_t ZigBee_QCLI_Handle);

/**
   @brief Creates an IAS ACE server cluster.
...
/**
   @brief Creates an IAS ACE client cluster.
