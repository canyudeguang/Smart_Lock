#ifndef _HTC_HOST_REG_REG_H_
#define _HTC_HOST_REG_REG_H_
...
#define HOST_INT_STATUS_ENDPOINT_DATA_MSB            3
#define HOST_INT_STATUS_ENDPOINT_DATA_LSB            0
#define HOST_INT_STATUS_ENDPOINT_DATA_MASK           0x0000000f
#define HOST_INT_STATUS_ENDPOINT_DATA_GET(x)         (((x) & HOST_INT_STATUS_ENDPOINT_DATA_MASK) >> HOST_INT_STATUS_ENDPOINT_DATA_LSB)
#define HOST_INT_STATUS_ENDPOINT_DATA_SET(x)         (((x) << HOST_INT_STATUS_ENDPOINT_DATA_LSB) & HOST_INT_STATUS_ENDPOINT_DATA_MASK)
...
#define ENDPOINT_FRAME_ADDRESS                       0x00000404
#define ENDPOINT_FRAME_OFFSET                        0x00000404
#define ENDPOINT_FRAME_RX_EOM_MSB                    7
#define ENDPOINT_FRAME_RX_EOM_LSB                    4
#define ENDPOINT_FRAME_RX_EOM_MASK                   0x000000f0
#define ENDPOINT_FRAME_RX_EOM_GET(x)                 (((x) & ENDPOINT_FRAME_RX_EOM_MASK) >> ENDPOINT_FRAME_RX_EOM_LSB)
#define ENDPOINT_FRAME_RX_EOM_SET(x)                 (((x) << ENDPOINT_FRAME_RX_EOM_LSB) & ENDPOINT_FRAME_RX_EOM_MASK)
#define ENDPOINT_FRAME_RX_SOM_MSB                    3
#define ENDPOINT_FRAME_RX_SOM_LSB                    0
#define ENDPOINT_FRAME_RX_SOM_MASK                   0x0000000f
#define ENDPOINT_FRAME_RX_SOM_GET(x)                 (((x) & ENDPOINT_FRAME_RX_SOM_MASK) >> ENDPOINT_FRAME_RX_SOM_LSB)
#define ENDPOINT_FRAME_RX_SOM_SET(x)                 (((x) << ENDPOINT_FRAME_RX_SOM_LSB) & ENDPOINT_FRAME_RX_SOM_MASK)

#define RX_LOOKAHEAD_VALID_ADDRESS               0x00000405
#define RX_LOOKAHEAD_VALID_OFFSET                0x00000405
#define RX_LOOKAHEAD_VALID_ENDPOINT_MSB              3
#define RX_LOOKAHEAD_VALID_ENDPOINT_LSB              0
#define RX_LOOKAHEAD_VALID_ENDPOINT_MASK             0x0000000f
#define RX_LOOKAHEAD_VALID_ENDPOINT_GET(x)           (((x) & RX_LOOKAHEAD_VALID_ENDPOINT_MASK) >> RX_LOOKAHEAD_VALID_ENDPOINT_LSB)
#define RX_LOOKAHEAD_VALID_ENDPOINT_SET(x)           (((x) << RX_LOOKAHEAD_VALID_ENDPOINT_LSB) & RX_LOOKAHEAD_VALID_ENDPOINT_MASK)
...
#define INT_STATUS_ENABLE_ENDPOINT_DATA_MSB          3
#define INT_STATUS_ENABLE_ENDPOINT_DATA_LSB          0
#define INT_STATUS_ENABLE_ENDPOINT_DATA_MASK         0x0000000f
#define INT_STATUS_ENABLE_ENDPOINT_DATA_GET(x)       (((x) & INT_STATUS_ENABLE_ENDPOINT_DATA_MASK) >> INT_STATUS_ENABLE_ENDPOINT_DATA_LSB)
#define INT_STATUS_ENABLE_ENDPOINT_DATA_SET(x)       (((x) << INT_STATUS_ENABLE_ENDPOINT_DATA_LSB) & INT_STATUS_ENABLE_ENDPOINT_DATA_MASK)
