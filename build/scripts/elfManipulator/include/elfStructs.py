...
#
#-------------------------------------------------------------------------------
#  $Header: //components/rel/core.ioe/1.0/bsp/build/scripts/elfManipulator/include/elfStructs.py#1 $
#  $DateTime: 2016/09/12 17:10:34 $
#  $Author: pwbldsvc $
#  $Change: 11350637 $
...
class Elf32_Ehdr(elfStruct):
    ...
    def setAndValidateStructMembers(self):
        ...
        if self.e_machine != const.elfMachineType.EM_ARM:
            utils.raiseElfManipulatorError("Elf32_Ehdr.e_machine failed validation.", self.e_machine)
